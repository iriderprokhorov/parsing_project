...
for div in a_tag:
    ...
    title = parsed.findAll(class_="news-card__title")
    pub_date = parsed.findAll(class_="news-card__date")
    tags_int = parsed.find(class_="news-card__mark")
    news_dict["title"] = title[i].get_text().replace("\n      ", "")
    news_dict["pub_date"] = pub_date[i].get_text()
